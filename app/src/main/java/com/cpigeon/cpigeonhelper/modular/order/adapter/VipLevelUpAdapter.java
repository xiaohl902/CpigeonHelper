...
public class VipLevelUpAdapter extends BaseQuickAdapter<PackageInfo,BaseViewHolder> {
    public VipLevelUpAdapter(List<PackageInfo> data) {
    ...
    protected void convert(BaseViewHolder helper, PackageInfo item) {
        ...
        helper.setText(R.id.tv_open_gytservice,"升级套餐");
